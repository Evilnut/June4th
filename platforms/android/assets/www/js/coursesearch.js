...
courseSearch.prototype.init = function () {
	// initial fuctions
	console.log("yaduo g_courseSearch init");
	...
	/* jqPagination - after returning from coursedetail page, if on last page, 
	   disable the next button*/
	if(g_courseSearchResults.m_page == g_courseSearchResults.m_lastPage){
